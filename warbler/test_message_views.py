...
class MessageViewTestCase(TestCase):
    ...
    # -adding invalid user   - adding no session
    ...
    #next we need to test an invalid message
    ...
    #test deleting a message and also invalid message deletion
    ...
    def test_unauthorized_message_delete(self):
        ...
        #we'll be faking a test to see if unauthorized user can delete a msg thats not theirs
